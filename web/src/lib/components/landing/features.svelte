<section id="features" class="p-4 sm:p-12 md:p-24">
    <div class="p-4 sm:p-6 md:p-10">
        <h1
            class="text-center font-bold text-2xl sm:text-3xl text-teal font-inter"
        >
            Features
        </h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-20">
            ...
            <div class="bg-back rounded-2xl p-6">
                ...
                <div class="border-t flex flex-col gap-5">
                    <!-- N E A R B Y -->
                    <h3 class="text-sm font-semibold text-teal mt-5">
                        Nearby Amenities
                    </h3>
                    <div class="flex items-center gap-2">
                        <svg
