<section id="about" class="p-4 sm:p-12 md:p-20">
  <div
    class="flex flex-col md:flex-row items-center gap-10 p-6 md:p-20 bg-back rounded-2xl"
  >
    <!-- about us -->
    <div class="w-full md:w-1/2 text-center md:text-justify">
      ...
      <p class="text-slate leading-relaxed mb-4">
        ...
        <span class="font-medium">Subic Bay Freeport Zone</span>, offering the
        perfect mix of accessibility and comfort.
      </p>
