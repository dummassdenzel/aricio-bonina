...
<button class="modal p-5 rounded-2xl border flex flex-col gap-4 relative"
  ...
  {#if isOccupied && current_lease}
    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-2">
        <div class="bg-lightteal text-teal text-xs font-bold rounded-full w-5 h-5 items-center text-center justify-center flex">
      ...
      <div class="flex gap-2 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#314A60" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"> <rect width="18" height="18" x="3" y="4" rx="2" ry="2" /> <line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></svg>
      ...
      <div class="flex items-center gap-2 justify-center bg-green20 p-2 px-4 rounded-full">
...
<style>
  ...
  .modal:hover {
    ...
    box-shadow: 0 6px 12px rgba(0, 0, 0, 0.15), 0 4px 10px rgba(0, 0, 0, 0.08);
  }
</style>
