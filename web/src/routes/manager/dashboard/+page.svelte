  ...
  <div class="mt-6 flex flex-col gap-6">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
      ...
      <div class="w-full lg:w-2/3">
        <div class="h-[300px] sm:h-[400px] bg-back border rounded-xl p-4">
      ...
      <div class="w-full lg:w-1/3 grid grid-cols-2 lg:grid-cols-1 gap-4">
        <div class="border rounded-xl p-4 bg-white">
          ...
          <p
            class="text-xl sm:text-2xl text-teal font-bold text-end font-inter"
          >
        ...
        <div class="border rounded-xl p-4 bg-white">
          <p class="text-xs text-teal font-medium">Occupied Units</p>
          <p
            class="text-xl sm:text-2xl text-teal font-bold text-end font-inter"
          >
        ...
        <div class="border rounded-xl p-4 bg-white">
          <p class="text-xs text-teal font-medium">Total Revenue (This Year)</p>
          <p
            class="text-xl sm:text-2xl text-brightgreen font-bold text-end font-inter"
          >
    ...
    <div class="mt-4">
      <h2 class="text-xl sm:text-2xl font-bold text-teal mb-4">
        Lease Overview
      </h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- Total Overdue -->
        <div
          class="border rounded-xl p-6 bg-white flex flex-col items-center justify-center"
        >
          <p class="text-base sm:text-lg text-teal font-bold text-center">
            Total of Overdue
          </p>
          <p class="text-4xl sm:text-5xl lg:text-6xl text-slate font-bold mt-2">
        ...
        <!-- Overdue List -->
        <div class="border rounded-xl p-4 bg-white">
          <p class="text-base sm:text-lg text-teal font-bold mb-3">
