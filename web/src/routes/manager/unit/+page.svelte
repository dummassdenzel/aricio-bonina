...
<h1 class="text-3xl font-bold text-teal">Unit Management</h1> <!-- ignore this -->
...
<section class=" mt-5">
    ...
    <!-- cards -->
    <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 overflow-auto max-h-[550px] scrollbar-none">
        <!-- sample card -->
        <UnitCard />
    </div>
</section>
